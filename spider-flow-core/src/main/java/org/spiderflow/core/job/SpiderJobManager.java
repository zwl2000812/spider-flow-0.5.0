...
public class SpiderJobManager {
	...
	public void run(String id, String ip){
		Spider.executorInstance.submit(()->{
			spiderJob.run(id, null);
		});
	}
//	public void remote_run(String spidername, String hostip){
//		Spider.executorInstance.submit(()->{
//			spiderJob.run(null, hostip,spidername);
//		});
//	}

	public void remote_run(JSONObject json){
		Spider.executorInstance.submit(()->{
			spiderJob.run(null, json);
		});
	}
