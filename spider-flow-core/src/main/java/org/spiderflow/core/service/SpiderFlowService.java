...
public class SpiderFlowService extends ServiceImpl<SpiderFlowMapper, SpiderFlow> {
	...
	public void run(String id, String ip){
		spiderJobManager.run(id, ip);
	}
//	public void remote(String spidername, String hostip){
//		spiderJobManager.remote_run(spidername, hostip);
//	}

	public void remote(JSONObject json){
		spiderJobManager.remote_run(json);
	}
